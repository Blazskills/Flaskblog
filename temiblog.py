...
class BlogPost(db.Model,UserMixin):
      #  __searchable__  = ['author','title','sub_title','content','blog_pix']
...
def reg():
   if request.method =='POST':
      ...
      if user_pix and allowed_file(user_pix.filename):
         ...
         user_pix.save(os.path.join('/home/blazskills/Documents/python class project/static/userpix',filename))
         url = str(filename)
...
def create_post():
   ...
   if request.method =='POST':
      ...
      if blog_pix and allowed_file(blog_pix.filename):
         ...
         blog_pix.save(os.path.join('/home/blazskills/Documents/python class project/static/blogpix',filename))
         url = str(filename)
